...
namespace AmritaDb.Tipsy.Infrastructure.Migrations
{
    ...
    [Migration("20230817054125_Receipt")]
            ...
            modelBuilder.Entity("AmritaDb.Tipsy.Domain.Retail.Receipt", b =>
                {
                    ...
                    b.Property<decimal>("CustomerGrandTotal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("money")
                        .HasDefaultValue(0m)
                        .HasColumnName("customer_grand_total_amount");

                    b.Property<string>("CustomerGrandTotalCurrency")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(3)
                        .HasColumnType("char(3)")
            ...
            modelBuilder.Entity("AmritaDb.Tipsy.Domain.Purchase.Settlement", b =>
                {
                    ...
                    b.HasOne("AmritaDb.Tipsy.Domain.Universal.PaymentMode", "Mode")
                        .WithMany("Settlements")
